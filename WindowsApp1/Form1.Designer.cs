...
namespace WindowsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            load_file_button.Click += new System.EventHandler(load_file_Click);
            ...
            find_invalid_mapping_button.Click += new System.EventHandler(find_exception_mapping_button_click);
            display_data_button = new Button();
            display_data_button.Click += new System.EventHandler(display_data_button_click);
            ...
            find_modbus_mapping_button.Click += new System.EventHandler(find_mapping_Click);
            load_ref_table_button = new Button();
            load_ref_table_button.Click += new System.EventHandler(load_ref_table_Click);
            RSS_file = new Label();
            rss_path = new Label();
            ...
            modbus_doc.Click += new System.EventHandler(modbus_doc_button_Click);
            save_button = new Button();
            save_button.Click += new System.EventHandler(save_rss_button_Click);
            generate_modbus_doc = new Button();
            generate_modbus_doc.Click += new System.EventHandler(generate_modbus_doc_Click);
