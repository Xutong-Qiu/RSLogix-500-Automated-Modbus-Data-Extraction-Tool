...
namespace WindowsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            load_file_button.Click += new System.EventHandler(load_file_button_Click);
            ...
            find_invalid_mapping_button.Click += new System.EventHandler(find_modbus_mapping_button_Click);
            ...
            find_modbus_mapping_button.Click += new System.EventHandler(find_modbus_mapping_button_Click);
            load_ref_table_button = new Button();
            load_ref_table_button.Click += new System.EventHandler(load_ref_table_button_Click);
            RSS_file = new Label();
            rss_path = new Label();
            ...
            modbus_doc.Click += new System.EventHandler(find_modbus_mapping_button_Click);
