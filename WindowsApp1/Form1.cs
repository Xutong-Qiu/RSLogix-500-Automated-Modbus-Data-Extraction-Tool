...
namespace WindowsApp1
{
    ...
    public partial class Form1
    {
        ...
        private void load_file_Click(object sender, EventArgs e)
        {
            ...
            if (db is not null)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (logixObj is not null)
                    {
                        ...
                        logixObj.Close((object)false, (object)false);
                    }
                }
            ...
            logixObj = WindowsApp1.IOHandler.LoadRSSFile(path, logixApp);
            if (logixObj is null)
            {
                return;
            }
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            ...
            {
                string s = "";
                List<string> l = db.GetMappingTarget(addr);
                foreach (var i in l)
                    s = s + i + " ";
                Label6.Text = s;
            }
        ...
        {
            List<string[]> content = db.GetExceptionMapping();
            ...
            WindowsApp1.IOHandler.WriteToCSV(content, new[] { "Address", "Name", "Source", "Description" }, filePath);
        ...
        private void find_mapping_Click(object sender, EventArgs e)
        {
            ...
            foreach (var addr in modifiedList)
            {
                ...
                foreach (var src in db.GetMappingSrc(addr))
                    str = Conversions.ToString(str + Operators.AddObject(src, " "));
        ...
        private void load_ref_table_Click(object sender, EventArgs e)
        {
            ...
            db.TagAbbrDictionary = WindowsApp1.IOHandler.LoadExcel(path);
        ...
        private void DataGridView1_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                DataGridView1.Sort(new WindowsApp1.DataGridEntryComparer(toggle));
                toggle = !toggle;
            }
        }
        ...
        private void save_rss_button_Click(object sender, EventArgs e)
        {
            ...
            {
                WaitForBGTask();
                WindowsApp1.IOHandler.WriteToProject(logixObj, db);
        ...
        private void generate_modbus_doc_Click(object sender, EventArgs e)
        {
            ...
            string filePath = Path.Combine(exePath, "Modbus Address.xlsx");
            var content = db.GetModbusData();
            WindowsApp1.IOHandler.GenerateModbusDoc(content, new[] { "Address", "Tag Name", "Description" }, filePath);
            Focus();
        }
    }
}